...
rm -rf build/lectron_fmu-v6x_default
make lectron_fmu-v6x_default

# Build output:
# build/lectron_fmu-v6x_default/lectron_fmu-v6x_default.bin  (Application firmware)
# build/lectron_fmu-v6x_default/lectron_fmu-v6x_default.px4  (QGroundControl package)
# build/lectron_fmu-v6x_default/lectron_fmu-v6x_default.elf  (Debug symbols)
```
