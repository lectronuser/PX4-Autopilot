...
rm -rf build/lectron_pi5-autopilot_default
make lectron_pi5-autopilot_default

# Build output:
# build/lectron_pi5-autopilot_default/lectron_pi5-autopilot_default.bin  (Application firmware)
# build/lectron_pi5-autopilot_default/lectron_pi5-autopilot_default.px4  (QGroundControl package)
# build/lectron_pi5-autopilot_default/lectron_pi5-autopilot_default.elf  (Debug symbols)
```
